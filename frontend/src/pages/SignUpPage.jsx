...
export default function SignUpPage({ onNavigate, onLogin }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Demo behavior: set logged in state and navigate to landing
    onLogin();
    onNavigate('landing');
  };
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start verifying claims and fighting misinformation</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            By creating an account, you agree to help build a more truthful information ecosystem
          </p>
        </div>
      </div>
    </div>
